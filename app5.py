...
data = requests.get(url, params={
    "address": "2922 hollinwell dr, katy, texas",
    "key": api_key
}).json()
...
def extract_data_5(data_5):
     return {
        "name": data_5["results"][5]["name"],
        "business_status": data_5["results"][5]["business_status"],
        "opening_hours": data_5["results"][5]["opening_hours"]["open_now"],
        "price_level": data_5["results"][5]["price_level"],
        "rating": data_5["results"][5]["rating"],
        "user_ratings_total": data_5["results"][5]["user_ratings_total"],
        "lat": data_5["results"][5]["geometry"]["location"]["lat"],
        "lng": data_5["results"][5]["geometry"]["location"]["lng"],
        "vicinity": data_5["results"][5]["vicinity"]
...
data_5 = extract_data_5(requests.get(url2, params={
    "location": lat_lng,
    "radius": 1000,
    "type": "restaurant",
    "key": api_key
...
restaurant_list_5.append(data_5) 
# pprint(restaurant_list_5)

df5 = pd.DataFrame(restaurant_list_5).drop_duplicates()
# # pprint(df5)
